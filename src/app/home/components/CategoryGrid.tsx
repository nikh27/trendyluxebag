...
const CategoryGrid = ({ className = '' }: CategoryGridProps) => {
  const categories: Category[] = [
  {
    ...
    alt: 'Elegant brown leather tote bag with structured design held by woman in beige coat',
    productCount: 45
  },
  {
    id: 'clutch',
    ...
    alt: 'Sophisticated black leather clutch with gold chain detail held by woman in evening wear',
    productCount: 32
  },
  {
    id: 'shoulder',
    ...
    alt: 'Luxurious camel leather shoulder bag with adjustable strap displayed on marble surface',
    productCount: 58
  },
  {
    id: 'crossbody',
    ...
    alt: 'Compact burgundy crossbody bag with gold hardware worn by woman in casual outfit',
    productCount: 41
  },
  {
    id: 'backpack',
    ...
    alt: 'Sleek black leather backpack with minimalist design worn by woman in urban setting',
    productCount: 28
  },
  {
    id: 'travel',
    ...
    alt: 'Large tan leather weekender bag with brass hardware on wooden floor near suitcase',
    productCount: 36
  }];
